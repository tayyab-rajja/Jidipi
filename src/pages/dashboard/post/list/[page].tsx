...
// This is the done for the post in Post page I will remove that code and wil add in the post tab of cloud
...
// import SidebarDashboard2 from "src/components/Dashboard/Sidebar/SidebarDashboard2";
// import styles from "src/components/Dashboard/Sidebar/SidebarDashboard.module.css";
...
//           <div className={styles["main-section-inner"]}>
//             <SidebarDashboard2 />
//             <div className={styles["page-main-part"]}>
//               <CloudContent />
//             </div>
//             <div>helk klrtrlt klertk</div>
//           </div>
//         </section>
//       </main>
//     </>
...
//     const currentPageFolder = pageFolders.find(
//       (page: any) => context.params && page.subDomain === context.params.page
//     );
//     props = {
//       competitions: c.competitions,
//       pageFolders,

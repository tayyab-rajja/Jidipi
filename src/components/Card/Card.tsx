  ...
  return (
    <div className={clsx(styles.Card, className && className)}>
      <Image
        ...
        width={500}
        height={500}
        src="data:image/png;base64,"
        alt="Card Img"
      />
